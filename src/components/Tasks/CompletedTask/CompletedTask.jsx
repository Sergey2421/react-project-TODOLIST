    ...
    function deleteCompletedTask() {
        ...
        <div className={Css.container}>
            ...
            <div className={Css.buttons}>
                <button className={Css.button} onClick={deleteCompletedTask}><img className={Css.img} src={'https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Crystal_button_cancel.svg/32px-Crystal_button_cancel.svg.png?20080403113445'}/></button>
            </div>
        </div>
    )
}
